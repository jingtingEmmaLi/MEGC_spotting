...
trainVecComposition  = '';%'_NoDistCnPente_filter';
%%

seuil_indensity = 0.9; %0.9
sampleRate2train = 8;
...
r_w_ROI = 1/3;
r_w_frame = 1;
fusionPath = [upperPath,'fusionResult',fileType,'/',bdd,'/size_',num2str(sizeROI),'/distSeuil_',num2str(seuil_indensity),'/boolen011_cn_0.4_rwori13_rw1_spa/'];
